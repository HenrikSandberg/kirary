        ...
        <div >
            {!user &&
                <header className="header">
                    <p>Lyst til å teste vårt nye produkt?</p>
                    <Link to='/signup'>
                        <button className='create-account-button'>Registrer deg</button>
                    </Link>
                </header>
            }
            ...
            <h1>Velkommen til Kirary</h1>
                ...
                <p>Dette er en beta av et helt nytt og spennende produkt for deg som ønsker 
                    å få mer insikt i hvordan planten din har det og hvordan å bedre sikre at 
                    den kan leve et langt og godt liv.
                </p>
